    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          className={cn(
            'bg-gray-900 border-gray-700 z-50 mx-auto flex w-full max-w-[calc(100%-2rem)] flex-col gap-4 rounded-3xl border p-6 shadow-lg shadow-black/5 sm:max-w-lg',
            Platform.select({
...
function DialogDescription({
  ...
  return <DialogPrimitive.Description className={cn('text-gray-300 text-sm', className)} {...props} />;
}
